...
Hvilken anden pathway kunne være influeret af mutationen og hvorfor? Hint: Kig på reaktionspathwayen for threonin, isoleucin og methionin.
...
Lav en scene, kaldet F3, som viser heparins binding til thrombin (PDB-ID: 3UTU). Hint: Brug align og util.protein_vacuum_esp. Stemmer heparins placering overens med det forventede bindingsite?

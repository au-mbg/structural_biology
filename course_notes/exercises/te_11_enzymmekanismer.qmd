...
Dette er baseret på Berg 10, kapitel 5.
:::
...
![Inhibition correct](figures/te_11/opgave-3-figur-1.jpeg){width="80%" fig-align="center" .lightbox}
...
EDTA (ethylene diamine tetra eddike syre, jf. struktur nedenfor) chelerer (binder kraftigt) en bestemt type molekyler. Hvilke enzymer fra Berg-Stryer's kapitel 6 ville den inhibere?

![](figures/te_11/opgave-6-figur-1.png){width="30%" fig-align="center" .lightbox}
...
![](figures/te_11/opgave-7-figur-1.jpeg){width="90%" fig-align="center" .lightbox}
...
2. Beskriv forskellen mellem de to strukturer, find det aktive site og kom med et bud på, hvorfor MHETasen har et domæne som PETasen ikke har, når det oplyses at MHETasen har en meget lav *k*~cat~.
...
![](figures/te_11/opgave-7-figur-4.jpeg){width="90%" fig-align="center" .lightbox}
...
4.  Som det første i funktionen bør der laves et såkaldt "space", hvor PyMOL kan tilgå data fra programmet. I praksis er dette blot et dictionary/et bibliotek. Heri kan oprettes lister, f.eks.: 

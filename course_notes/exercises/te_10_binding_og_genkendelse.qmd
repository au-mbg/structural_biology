---
title: "TØ 10 -- Binding og genkendelse"
---
...
1.  Vi skal nu udlede og anvende en simpel matematisk funktion til at beskrive kooperativ binding, den såkaldte *Hill ligning* (ikke noget med bakker men derimod den gode *Archibald Hill*). Lad os tage udgangspunkt i en simpel binding af substrat S til protein X:
    ...
    ![](figures/te_10/opgave-3-figur-1.png){width="80%" fig-align="center"}

    Her gælder at mætningsgraden Y (altså hvor stor en brøkdel af X proteinerne har bundet S) kan skrives som:

    ![](figures/te_10/opgave-3-figur-2.png){width="80%" fig-align="center"}
    ...
    ![](figures/te_10/opgave-3-figur-3.png){width="80%" fig-align="center"}

    Vis hvordan dette fører til Hill-ligningen:

    ![](figures/te_10/opgave-3-figur-4.png){width="80%" fig-align="center"}

::: {.callout-solution}
Dette følger af det simple sammenhæng 

![](figures/te_10/opgave-3-figur-5.png){width="60%" fig-align="center" .lightbox}
:::

2. Plot en iltbindingskurve for et hypotetisk two-subunit hæmoglobin med kooperativitstallet *n* = 1.8 og p(O~2~) = 10 torr.
...
![](figures/te_10/opgave-3-figur-7.png){width="80%" fig-align="center"}
...
![Ilt-bindingskurver](figures/te_10/opgave-3-figur-6.png){width="50%" fig-align="center" .lightbox}
...
2. Lav et Hill plot udfra disse data. Angiver dette plot kooperativitet? Hvad er Hill koefficienten?

::: {.callout-solution}
Her skal log (Y/(1-Y)) plottes mod log (p(O~2~)) hvor hældningen giver kooperativitetskoefficienten *n*.

![](figures/te_10/opgave-4-figur-1.png){width="80%" fig-align="center" .lightbox}
...
![TØ uge 43 lampret](figures/te_10/opgave-4-figur-2.png){width="80%" fig-align="center" .lightbox}
:::
...
![Y versus substrate](figures/te_10/opgave-5-figur-1.png){width="80%" fig-align="center" .lightbox}
...
![succinate versus wavelength](figures/te_10/opgave-5-figur-2.png){width="80%" fig-align="center" .lightbox}

3. Hvad er betydningen af ændringen i 430 nm signalet?
...
![ATP and CTP versus wavelength](figures/te_10/opgave-5-figur-3.png){width="80%" fig-align="center" .lightbox}

4. Hvad er betydningen af disse ændringer i absorbtionen af reporter-sidekæderne?

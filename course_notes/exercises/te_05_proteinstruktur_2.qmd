...
Tegn et topologisk foldningsdiagram og lokaliser "switch point" (jvf P&R side 38-39). Lokaliser også switchpoint i PyMOL og lav en scene kaldet F2, der visualiserer dette. Hint: Brug specrum kommandoen (spectrum count, rainbow, 1AUG) på én af kæderne.
...
### Find β-galactosidasens KM og Vmax

Hvad er K~M~-værdien for β-galactosidase overfor det stærkest bindende substrat, man har målt? Hvad er V~max~ for enzymet med dette substrat?

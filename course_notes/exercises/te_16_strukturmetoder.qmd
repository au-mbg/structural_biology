...
7. Skjul LeuT1 og farv backbone efter B-faktor med en gradient fra blå til hvid til rød.

8. Vis LeuT2 med en overflade farvet efter "vacuum electrostatics".
...
1.  Forklar med dine egne ord hvorfor kun bestemte vinkler giver konstruktiv interferens. Brug Braggs lov 
...
3.  Ved en bølgelængde af røntgenstrålen $\lambda = 1.5 \ \mathrm{Å}$.
...
Vi skal kigge på et lille udsnit af elektrontætheden, som kan ses ved at åbne `elektrondensitet.pse` som kan downloades nedenfor.
...
::: {.callout-solution}
Store aminosyrer Y og F er markeret i fed herunder:

<pre>
MN<strong>Y</strong>KELEKMLDVI<strong>F</strong>ENSEIKEIDL<strong>FF</strong>D
</pre>

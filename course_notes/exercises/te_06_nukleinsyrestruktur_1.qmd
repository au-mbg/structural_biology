...
Åben det vedhæftede script **TALE.pml** i PyMOL. Tryk **F1** og **F2** for at se DNA-protein komplekset hhv. fra siden og langs helix aksen. Tryk **F3** for at se sphere-repræsentation, hvor man lettere kan se repeat-strukturen. Tryk **F4** for at se en specifik interaktion mellem protein og DNA. I hvilken groove af DNA-dobbelthelixen binder TALE-proteinet? Forklar hvordan du observerer dette.
...
reinitfetch 1BDT, type=pdb1, async=0remove solventset_view (\\
...
color purple, ss h & chain A+B+C+Dcolor yellow, ss s & chain A+B+C+Dcolor cyan, ss l+'' & chain A+B+C+D
...
show sticks, resi 8-14 and chain A+B+C+Dutil.cbac resi 8-14 and chain A+B+C+D

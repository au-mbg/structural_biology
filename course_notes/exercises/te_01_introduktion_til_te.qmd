...
2.	Nedenfor vises et udsnit af en peptidkæde, der har sekvensen DKCQGG. Hvilke af følgende udsagn er korrekte:
    ...
    b.	Den gule streg omgiver kun cystein aminosyreresten
    c.	Den grønne streg omgiver kun lysine sidekæden
    d.	Den røde streg omgiver kun glutamin sidekæden
    e.	Den violette streg omgiver kun aspartat aminosyreresten

![](figures/te_01/opgave-4-figur-2.png){width="60%" .lightbox fig-align="center"}

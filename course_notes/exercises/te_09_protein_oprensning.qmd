...
::: {.callout-solution}
Vi ser et bånd ved ca. 40 kDa for den første top (ca. fraktion 44 på Ultrogel AcA 54) og et bånd ved ca. 20 kDa for den anden top (fraktion 68). Vi kan nu sige med en vis sikkerhed at de tre proteiner ikke danner multimerer og eluerer som forventet. Der er dog en teoretisk mulighed for at de alle tre danner f.eks. dimerer, så det vi faktisk ser er én top svarende til 80 kDa og to proteiner svarende til 40 kDa. For at afklare dette er man nødt til at kalibrere sin søjle med kendte proteiner (se senere opgave).
:::
...
DEAE-cellulose, hvor DEAE står for diethylaminoethyl, en tertiær aminogruppe,
...
ladede og ingen af dem vil binde, mens de ved pH 8 alle vil være
...
::: {.callout-solution}
Når saltkoncentrationen stiger vil de små ioner efterhånden
...
::: {.callout-solution}
Vi observerer to toppe ved pH 7,0, én i vasken og én sent i gradienten. I den første top (vask, fraktion 20) observerer vi proteiner ved 20 og 40 kDa, mens vi fra toppen i gradient (fraktion 106) kun ser et protein ved 20 kDa. Dette er forventet, da to proteiner ikke skulle binde ved pH 7.0. Vi har altså fået separeret de to proteiner ved 20 kDa på baggrund af deres forskellige pI-værdier, hvilket ikke var muligt med gelfiltrering.
:::
...
fyret. Din chef støtter dig dog under den betingelse, at du forsikrer dem
...
MW (og ca. 40 kDa for det andet). 
Da enzym aktivitet blev målt i fraktionerne med to proteiner, 
må enzymet derfor have MW 20 kDa
...
koncentration og enzymaktivitet:
...
Din næste opgave er at kalibrere en gelfiltreringssøjle, hvilket gøres ved at
analysere en blanding af proteiner med kendte masser. Dette er et meget
...
2.  Notér elueringsvolumenet (fraktionsnummeret) for hver top (midten
    af peaken).
...
være en trimer bestående af 3 subunits med hver denne masse.
:::
...
1.  Identificér proteinet på gelen og notér dets MW og pI.
...
Du starter med en gelfiltrering med det valgte søjlemateriale og får
...
5.  1D-gelen afslører at prøven er kontamineret. Hvordan kan der være
    kontaminering, når du ved at alle de andre proteiner i prøven er meget
    mindre?
...
::: {.callout-solution}
Nej, vil gerne have højere udbytte. Vælger fraktion 15-35 på gelfiltreringssøjlen for at få mere af den rigtige peak med i første omgang.
:::

Du kører en gelkalibrering af din søjle med proteiner med standard masse
(som i opgave 5) og estimerer massen af dit nyoprensede protein til at
være 465 kDa.
...
Du har nu endelig fået oprenset dit protein og arbejder over de kommende
...
1.  Røntgenkrystallografi af din proteinkrystal giver en opløsning på 1,5 Ångström, 
    hvilket tillader dig at bygge en præcis atomar model (X-ray.pdb). 
    Åbn modellen i PyMOL og farv kæder. Hvor mange kæder er der i proteinet?

{{< download-button path="../files/TE9-X-ray.pdb" filename="X-ray.pdb" >}}

::: {.callout-solution}
4 kæder
:::

2.  Dit protein er også blevet undersøgt ved hjælp af kryo-elektronmikroskopi 
    og gav et cryo-EM-kort med 2,2 Å opløsning. Du bygger også modellen ihht. dette kort. 
    Åbn modellen (Cryo-EM.pdb) og sammenlign X-ray data ved at aligne de to proteiner. 
    Hvad er RMSD? 

{{< download-button path="../files/TE9-Cryo-EM.pdb" filename="Cryo-EM.pdb" >}}
...
3.  Farvelæg de to modeller ihht. B-faktor. Viser de to modeller fleksibilitet i de samme områder
    og hvad kan være årsagen til forskelle?

::: {.callout-solution}
```default
spectrum b, blue_cyan_green_yellow_orange_red, X-ray, minimum=0, maximum=100
spectrum b, blue_cyan_green_yellow_orange_red, Cryo-EM, minimum=0, maximum=100
```

Ja, de er overordnet fleksible i de samme områder. Dog er der nogle områder, hvor krystalstrukturen
er mere stabil, hvilket kan skyldes krystalkontakter.
:::

4.  Søg med en del af sekvensen (som I kan aflæse i PyMOLs SEQ panel) med Protein BLAST
    (<https://blast.ncbi.nlm.nih.gov/>) for at finde ud af hvilket
    protein det er? (se note)

::: {.callout-tip title="Note"}
Dette scenarie er ikke realistisk, da man, som I vil lære om senere, vil bruge massespektrometri til at identificere proteinet på et tidligt tidspunkt.
:::
...
for dine evner indenfor protein oprensning, X-ray og cryo-EM og får

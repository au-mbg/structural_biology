...
### Find antal LDH-isoformer i UniProt
...
### Find betegnelser for LDH-varianter
...
### Find kromosomer for LDH-generne
...
### Tæl splejsningsvarianter af LDH-M
...
### Bestem PALA's inhibitionstype og styrke
...
### Identificer pathway påvirket af mutationen
...
### Beskriv ATCases T-til-R-overgang
...
### Identificer hvilke subunits binder ligander
...
### Forklar PALA's analytiske anvendelighed
...
### Forklar PALA som aktivator og inhibitor
...
### Forklar ikke-autokatalytisk aktivering
...
### Sammenlign thrombins og trypsins substratgenkendelse
...
### Identificer heparins kemiske gruppe
...
### Forudsig heparins bindingspartnere
...
![](figures/te_12/opgave-4-figur-2.png){width="90%" fig-align="center" .lightbox}
...
![](figures/te_12/opgave-4-figur-3.png){width="45%" .lightbox}
...
![](figures/te_12/opgave-4-figur-5.png){width="90%" fig-align="center" .lightbox}
...
### Visualiser thrombins elektrostatiske overflade
...
### Sammenlign heparins bindingssite i PyMOL
...
### Forklar behovet for antithrombin

Hvorfor har kroppen brug for en inhibitor som antithrombin?

::: {.callout-solution}
Kræves for at stoppe størkningsprocessen af blod igen. Se Stryer s. 328-331.
:::

### Analyser heparins effekt på serpinaktivitet
...
### Visualiser antithrombin-thrombin-komplekset
...
### Sammenlign heparinbinding på factor XIa
...
### Bestem factor Xa's substratspecificitet
...
### Skitsér SDS-PAGE af prothrombin-aktivering
...
### Forklar factor XIIIa's stabilisering af blodklump

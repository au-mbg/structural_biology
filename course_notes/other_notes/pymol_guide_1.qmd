...
![**Figure 1**: The PyMOL graphical user interface with PDB ID **1tg7** loaded.](pymol_guide_1_media/media/image1_annotated.png){.lightbox}
...
![**Figure 2**: Example of view of PETG bound to *E. coli* LacZ.](pymol_guide_1_media/media/image4.png)
